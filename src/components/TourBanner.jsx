...
//           <ul>
//             <li>Acesso a 2 aulas exclusivas com José "Hollywood"</li>
...
//             <li>Meet & Greet privado com José "Hollywood"</li>
...
//           <p>Brasil: PIX, cartão de crédito (até 12x) ou boleto bancário</p>
//           <p>Costa Rica: Transferência SINPE, tarjeta de crédito o efectivo</p>

//           <h4>Política de Reembolso</h4>
//           <p>Cancelamentos até 7 dias antes do evento têm direito a 80% de reembolso. Após este período, não serão realizados reembolsos.</p>
//         </div>
//       </div>
//     </div>
//   );
...
//           </h2>
//           <p className="tour-subtitle">MASTERCLASS • CASTING • EXPERIÊNCIA VIP</p>
//         </div>
...
//                 <span className="artist-name">JOSE "HOLLYWOOD"</span>
//                 <span className="artist-bio">Coreógrafo de Beyoncé, Rihanna, Jennifer Lopez e mais</span>
//               </div>
//             </div>
//           </div>
...
//               <p>Uma experiência única com um dos maiores coreógrafos do mundo. Aprenda, dance e faça parte de um momento histórico na dança latino-americana.</p>
...
//                 <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="cta-button brazil">
...
//                   </span>
//                 </a>
//                 <a href="https://wa.me/50688888888" target="_blank" rel="noopener noreferrer" className="cta-button costa-rica">
//                   <span className="flag">🇨🇷</span>
//                   <span className="cta-text">
...
//               </button>
//               <p className="payment-methods">Pagamentos em até 12x no cartão</p>
//             </div>
//           </div>
//         </div>
//       </div>
